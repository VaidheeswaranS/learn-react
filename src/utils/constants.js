 ...
 * Check for the title 'Top restaurant chains in Chennai' in the API response from the network tab
 */
export const RESTAURANT_LIST_API = 'https://www.swiggy.com/dapi/restaurants/list/v5?lat=13.0066625&lng=80.2206369&is-seo-homepage-enabled=true&page_type=DESKTOP_WEB_LISTING';
